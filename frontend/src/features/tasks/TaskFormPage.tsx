            ...
            {projectMembers.length === 0 ? (
              ...
              <div className="rounded-lg border border-fx-border divide-y divide-fx-border/60 overflow-hidden">
                <button
                  ...
                  className={cn('flex w-full items-center justify-between p-3 text-left text-xs hover:bg-fx-bg-hover', !assigneeId && 'bg-fx-green-soft/40')}
                >
                  <span className="font-medium text-fx-text-primary">Unassigned</span>
                  {!assigneeId && <Check className="h-4 w-4 text-fx-green" />}
                </button>
                {filteredMembers.map((m) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn('flex w-full items-center justify-between p-3 text-left text-xs hover:bg-fx-bg-hover', selected && 'bg-fx-green-soft/40')}
                    >
                      <span>
                ...
                filteredTasks.map((task) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn('flex w-full items-center justify-between gap-3 p-3 text-left text-xs hover:bg-fx-bg-hover', selected && 'bg-fx-green-soft/40')}
                    >
